...
export type AppIconName = keyof typeof IconsMap | string;

const materialToLucide: Record<string, keyof typeof IconsMap> = {
...
export const AppIcon: React.FC<AppIconProps> = ({ name, className, size, strokeWidth = 2, label }) => {
  const resolvedName = (materialToLucide[String(name)] || String(name)) as string;
  const IconComponent = (IconsMap as Record<string, LucideIcon>)[resolvedName] || Circle;
