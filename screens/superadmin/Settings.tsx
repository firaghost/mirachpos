              ...
              <section className="bg-[#2c2417] border border-[#483c23] rounded-lg overflow-hidden">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      <select value={draft.defaultCurrency} onChange={(e) => setDraft((d) => ({ ...d, defaultCurrency: e.target.value }))} disabled={loading || saving} className="w-full bg-[#1a150d] border border-[#483c23] rounded text-white px-4 py-2.5 focus:ring-1 focus:ring-[#eead2b] focus:border-[#eead2b] text-sm appearance-none focus:outline-none disabled:opacity-60">
